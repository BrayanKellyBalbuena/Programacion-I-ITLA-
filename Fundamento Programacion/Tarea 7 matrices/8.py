...
print(' Programa Lee una matriz 5x4 entera y determina cuántos números almacenados en ella terminan en 34.\n')
def clear(): 
    if os.name == "posix":
...
def  proceso():
    ...
    for i in range(5):
        for d in range(4):
            if matriz[i][d] % 100 == 34:
                b += 1
            
    print(matriz,"\n")
    print("Hay",b,"numeros que terminan en 34\n")
    cont()
