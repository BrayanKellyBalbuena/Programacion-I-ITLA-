...
print('Programa Lee una matriz 4x6 entera y determina en qué posiciones están los menores pares por fila.\n')
def clear(): 
    if os.name == "posix":
        ...
        for d in range(6):
            if matriz[i][d] % 2 == 0:
                if matriz[i][d] < mnp:
                    ...
                    nmp = d+1
            if  d == 5:
                print ("El menor par esta en la fila",i+1,"","esta en la columna",nmp,'\n')
                mnp = 99**123
