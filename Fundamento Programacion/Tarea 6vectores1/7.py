...
import sys
import time
print("""programa que leer 10 números enteros, almacena en un vector y determina cuántos números  tienen menos de 3 dígitos.\n.""")
def clear():
    if os.name == "Posix":
...
def proceso():
    ...
    if c == 0 :
        print("No hay numeros menores de tres cifras\n")
    else:
        print(" Hay",c," numeros menores de tres cifras\n")    
    cont()
proceso()
