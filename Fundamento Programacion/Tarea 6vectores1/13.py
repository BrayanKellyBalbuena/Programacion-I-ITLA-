...
import sys
import time
print("Programa lee 10 números enteros, almacenarlos en un vector y determinar si existe al menos u número repetido.\n")
...
def proceso():
    ...
    for ind in range(1,10):
        if vector[ind] == vector[pos_may]:
            print("Existe un numero repetido\n")
            p+=1
            break
        else:
            pos_may+=1
    if p == 0 :
        print("No existe numeros rrepetidos en el vector")
    cont()
