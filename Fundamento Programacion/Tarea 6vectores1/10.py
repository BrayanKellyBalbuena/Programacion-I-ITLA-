...
import sys
import time
print("""Programa  Lee 10 números enteros, almacena en un vector y determina cuántos números negativos hay.\n""")
...
def proceso():
    ...
    if c==0 :
        print("No hay negativos  en el vector\n")
    else:
        print("Hay",c,"negativos en el vector\n")
    cont()
