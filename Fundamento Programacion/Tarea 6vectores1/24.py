...
import sys
import time
print(""" Programa lee 10 números enteros, almacena en un vector y determina cuántos datos almacenados son múltiplos de 10 no utilizar el 10.\n""")
...
def proceso():
    ...
    if c==0 :
        print("No hay multiplos de 10 en el vector\n")
    else:
        print("Hay",c,"multiplos de 10 en el vector\n")
    cont()
