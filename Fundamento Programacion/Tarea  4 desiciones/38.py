...
def cal():
   try:
      ...
      if num2 == 0:
       ...
       cal()
   if (abs(num) % 10 == abs(num1) % 10) and (abs(num1) % 10 == abs(num2) % 10):
      print("Los ultimos digitos de los numeros",num,' ',num1,' ',num2,"son iguales\n")
      cont()
   else:
      print("Los ultimos digitos de los numeros",num,num1,num2,"no son iguales\n")
      cont()
