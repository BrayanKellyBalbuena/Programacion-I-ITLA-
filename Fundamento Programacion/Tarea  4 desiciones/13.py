...
def cal():
   try:
      ...
      if Errormuchosdig(num,num1) == True:   
         print("!Error! Deben ser un numero entero de dos digitos\n")
         cal()      
   except (ValueError):
   ...
   resul = num + num1
   if resul % 2 == 0:   
      print("La suma de los dos numeros  origina un numero par y es:",resul,"\n")
      cont()
   else:
      print("La suma de los dos numeros no origina un numero par y es:",resul,"\n")
      cont()
